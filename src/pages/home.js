            ...
            <div className="h-screen">
                ...
                <div className="flex h-screen justify-center items-center lg:justify-start lg:p-72">
                    <div className="grid text-center lg:text-left overflow-hidden">
                        <h1 className="text-gray-300 text-4xl md:text-6xl lg:text-7xl font-outfit">Yovie-Kobba</h1>
                        <p onLoad={job()} id="job" className="text-gray-300 mt-2 lg:ml-2 md:mt-4 md:text-xl lg:text-2xl">Machine Learning and AI Enthusiast</p>
