...
export default function Moe() {
    ...
    return ( <
        ...
        /svg> <
        /Link> <
        a href = "https://listen.moe"
        className = "text-center text-gray-200 text-2xl font-outfit" > Listen Moe < /a> <
        /div>
        ...
        <
        a id = "title"
        href = "https://listen.moe"
        className = "text-gray-200 text-center font-outfit text-3xl" > Nothing Playing < /a> <
        /div> <
        /div> <
        /div>
        ...
        div className = "grid" >
        <
        input onInput = { volume }
        id = "volume"
        type = { 'range' }
        className = "slider mb-16 cursor-pointer transition duration-500 opacity-70 hover:opacity-100" > < /input> <
        div className = "flex items-center gap-10" >
        <
        div className = "cursor-pointer transition duration-500 opacity-70 hover:opacity-100"
        onClick = { back } >
        <
        svg xmlns = "http://www.w3.org/2000/svg"
        ...
        div id = "play"
        onClick = { play }
        className = "cursor-pointer transition duration-500 opacity-70 hover:opacity-100" >
        <
        svg xmlns = "http://www.w3.org/2000/svg"
        ...
        div id = "pause"
        onClick = { pause }
        className = "hidden cursor-pointer transition duration-500 opacity-70 hover:opacity-100" >
        <
        svg xmlns = "http://www.w3.org/2000/svg"
        className = "h-24 w-24 text-gray-200"
        viewBox = "0 0 20 20"
