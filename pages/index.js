      ...
      <div className="container px-4 mx-auto lg:px-32 lg:pt-20">
        ...
        <div className="py-20">
          ...
          <Section
            id="about"
            title="About Me"
            description="Hi i am Yovie, a Web Developer & AI Developer from Indonesia. While i am proficient in FullStack developer, My Expertise is in FrontEnd Web Development such as React, Node, Gatsby, etc"
          />
          <About />
